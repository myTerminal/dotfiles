...
What started as [[https://github.com/myTerminal/dotfiles/tree/b384107562817ef181111c8c27bccaaa47614975][a home for my Emacs config]], collided with a spreadsheet containing a collection of software packages, [[https://github.com/myTerminal/dotfiles/tree/6bec073e40d7a1065b8c871f2158afb5b2a3debc][quickly began to shift its shape]], soon turning into a comprehensive *dotfiles* project to host configuration for much more than just Emacs. The majority of it [[https://github.com/myTerminal/dotfiles/tree/v1.0.0][still mostly comprised of Emacs configuration]], so to make things simpler, I decided to extract it into [[https://github.com/myTerminal/.emacs.d][an independent project of its own]]. At one point, I even extracted the setup scripts into their separate projects [[https://github.com/myTerminal/forge-legacy][here]] and then later [[https://github.com/myTerminal/forge][here]]. Maintaining it was still tricky with its [[https://github.com/myTerminal/dotfiles/tree/v2.0.0][complex arrangement of configuration files for four operating platforms]] at once at one point in time! What you see now is an attempt to keep only what is relevant to my primary setup across all my active workstation. This helps make updates less painful and effortless.
...
| Session manager       | [[https://github.com/elogind/elogind][elogind]]                                                            | --                                             |
...
| File system tools     | [[https://github.com/sharkdp/fd][fd]], [[https://github.com/eza-community/eza][eza]], [[https://github.com/sharkdp/bat][bat]], [[https://dev.yorhel.nl/ncdu][ncdu]]                                                 | [[https://github.com/sharkdp/fd][fd]], [[https://github.com/eza-community/eza][eza]], [[https://github.com/sharkdp/bat][bat]], [[https://dev.yorhel.nl/ncdu][ncdu]]                             |
...
| Network tools         | [[https://wiki.gnome.org/Projects/NetworkManager][networkmanager]], [[https://wiki.archlinux.org/title/Iwd][iwd]], [[https://www.isc.org/bind][bind-utils]], [[https://github.com/stefanha/nfs-utils][nfs-utils]], sv-netmount, [[https://tailscale.com][tailscale]] | --                                             |
...
| TTS                   | [[https://github.com/rhasspy/piper][piper]]                                                              | [[https://github.com/rhasspy/piper][piper]]                                          |
...
| Misc                  | [[https://github.com/hanslub42/rlwrap][rlwrap]], [[https://www.gnu.org/software/sed][sed]], [[https://jqlang.github.io/jq][jq]], [[https://github.com/fastfetch-cli/fastfetch][fastfetch]], [[https://www.gnu.org/software/wget][wget]], [[https://curl.se][curl]], [[http://www.dest-unreach.org/socat][socat]], [[https://www.openssh.com][ssh]], [[https://github.com/lathiat/avahi][avahi]]          | [[https://github.com/hanslub42/rlwrap][rlwrap]], [[https://www.gnu.org/software/sed][sed]], [[https://jqlang.github.io/jq][jq]], [[https://curl.se][curl]], [[http://www.dest-unreach.org/socat][socat]], [[https://github.com/fastfetch-cli/fastfetch][fastfetch]], [[https://github.com/lathiat/avahi][avahi]] |

*** Graphical packages

| Use-Case                 | Void (Xorg)                                      | Void (Wayland)                                   | macOS                                            |
|--------------------------+--------------------------------------------------+--------------------------------------------------+--------------------------------------------------|
...
| Writing interface        | [[https://obsidian.md][Obsidian]]                                         | [[https://obsidian.md][Obsidian]]                                         | [[https://obsidian.md][Obsidian]]                                         |
| Web browsers             | [[https://www.waterfox.com][waterfox]], [[https://www.chromium.org][Chromium]], [[https://mullvad.net/en/browser][Mullvad Browser]], [[https://www.torproject.org][Tor Browser]] | [[https://www.waterfox.com][Waterfox]], [[https://www.chromium.org][Chromium]], [[https://mullvad.net/en/browser][Mullvad Browser]], [[https://www.torproject.org][Tor Browser]] | [[https://www.waterfox.com][Waterfox]], [[https://www.chromium.org][Chromium]], [[https://mullvad.net/en/browser][Mullvad Browser]], [[https://www.torproject.org][Tor Browser]] |
...
| Messengers               | [[https://telegram.org][telegram-desktop]]                                 | [[https://telegram.org][telegram-desktop]]                                 | [[https://telegram.org][telegram-desktop]]                                 |
...
| Gaming clients           | [[https://store.steampowered.com][Steam]], [[https://lutris.net][lutris]]                                    | [[https://store.steampowered.com][Steam]]**, [[https://lutris.net][lutris]]                                  | [[https://store.steampowered.com][Steam]], [[https://www.origin.com][Origin]], [[https://www.playstation.com/en-us/explore/ps4/remote-play][Sony Remote Play]]                  |
...
*** Cloud Tools, Platforms & Services

| Use-Case                      | Personal                          | Collaboration            |
|-------------------------------+-----------------------------------+--------------------------|
| To-Do / Planning              | [[https://ticktick.com][TickTick]]^                         | ClickUp^                 |
| Email                         | Exchange ([[https://mailbox.org][Mailbox.org]])            | --                       |
| Contacts                      | Exchange ([[https://mailbox.org][Mailbox.org]])            | --                       |
| Calendar                      | Exchange ([[https://mailbox.org][Mailbox.org]])            | --                       |
| Web Bookmarks                 | [[https://raindrop.io][Raindrop.io]]^                      | --                       |
| Messaging                     | [[https://telegram.org][Telegram]], [[https://matrix.org][Matrix]], [[https://www.whatsapp.com][WhatsApp]]^       | [[https://discord.com][Discord]]^, [[https://matrix.org][Matrix]], [[https://zulip.com][Zulip]]^ |
| IP Telephony                  | [[https://voice.google.com][Google Voice]]^                     | --                       |
| Fediverse (Social Networking) | [[https://fosstodon.org][Fosstodon]]^, [[https://pixelfed.de][PixelFed]]^, [[https://lemmy.zip][Lemmy.zip]]^ | --                       |
| File Sync                     | [[https://syncthing.net][Syncthing]]^$                       | --                       |
| File Storage                  | [[https://drive.google.com][Google Drive]]^, [[https://www.pcloud.com][pCloud]], USB HDDs   | --                       |
| Source Code Hosting           | [[https://github.com][Github]]^                           | [[https://github.com][GitHub]]                   |
| Home Automation               | [[https://www.home-assistant.io][Home Assistant]]^$                  | --                       |
| Home Security                 | [[https://ring.com][Ring^]]                             | --                       |
| AI Agent                      | [[https://hermes-agent.org][Hermes]]$, [[https://get-hermes.ai][Hermes Web UI]]^$          | --                       |
...
=*= - in-built, =**= - through XWayland, =^= - web-client, =$= - self-hosted

** Open Gaps in Wayland

- Missing alternative for [[https://github.com/phw/peek][peek]]
- [[https://launchpad.net/onboard][onboard]] doesn't work
- No screen recording tools
- Broken sharing
- No way to set Numlock
- Wallpaper doesn't randomize after first load
- Need to set shell colors?
