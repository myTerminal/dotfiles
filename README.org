...
What you see now is an attempt to keep only what is relevant to my primary configuration across all my active workstations so that updates are less painful and effortless. There is more than one reason to keep configuration for macOS around, one of them is to use them on my work computers that stand out from my personal machines, and the other is to compare my "custom" setup with a fully-fledged family of macOS.
