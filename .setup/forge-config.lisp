(
 ...
 (
  ...
  (:pop ("systemctl --user enable syncthing.service"
         ...
         "systemctl --user enable libvirtd.service"
         "systemctl --user start libvirtd.service"
         "systemctl --user enable virtlogd.service"
         "systemctl --user start virtlogd.service"
